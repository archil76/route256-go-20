...
type OrderRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, order model.Order) (op1 *model.Order, err error)
	...
	funcSetStatus          func(ctx context.Context, order model.Order, status model.Status) (err error)
	funcSetStatusOrigin    string
	inspectFuncSetStatus   func(ctx context.Context, order model.Order, status model.Status)
	afterSetStatusCounter  uint64
	beforeSetStatusCounter uint64
	SetStatusMock          mOrderRepositoryMockSetStatus

	funcUpdateOrder          func(ctx context.Context, order model.Order) (op1 *model.Order, err error)
...
func (mmCreate *mOrderRepositoryMockCreate) Expect(ctx context.Context, order model.Order) *mOrderRepositoryMockCreate {
...
func (mmCreate *mOrderRepositoryMockCreate) ExpectOrderParam2(order model.Order) *mOrderRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("OrderRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mOrderRepositoryMockCreate) Inspect(f func(ctx context.Context, order model.Order)) *mOrderRepositoryMockCreate {
...
func (mmCreate *mOrderRepositoryMockCreate) Return(op1 *model.Order, err error) *OrderRepositoryMock {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("OrderRepositoryMock.Create mock is already set by Set")
	}
	...
	mmCreate.defaultExpectation.results = &OrderRepositoryMockCreateResults{op1, err}
	mmCreate.defaultExpectation.returnOrigin = minimock.CallerInfo(1)
	return mmCreate.mock
}

// Set uses given function f to mock the OrderRepository.Create method
func (mmCreate *mOrderRepositoryMockCreate) Set(f func(ctx context.Context, order model.Order) (op1 *model.Order, err error)) *OrderRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mOrderRepositoryMockCreate) When(ctx context.Context, order model.Order) *OrderRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("OrderRepositoryMock.Create mock is already set by Set")
	}
...
func (e *OrderRepositoryMockCreateExpectation) Then(op1 *model.Order, err error) *OrderRepositoryMock {
	e.results = &OrderRepositoryMockCreateResults{op1, err}
	return e.mock
}
...
func (mmSetStatus *mOrderRepositoryMockSetStatus) Expect(ctx context.Context, order model.Order, status model.Status) *mOrderRepositoryMockSetStatus {
	...
	mmSetStatus.defaultExpectation.params = &OrderRepositoryMockSetStatusParams{ctx, order, status}
...
// ExpectOrderParam2 sets up expected param order for OrderRepository.SetStatus
func (mmSetStatus *mOrderRepositoryMockSetStatus) ExpectOrderParam2(order model.Order) *mOrderRepositoryMockSetStatus {
	if mmSetStatus.mock.funcSetStatus != nil {
		mmSetStatus.mock.t.Fatalf("OrderRepositoryMock.SetStatus mock is already set by Set")
	}
	...
	mmSetStatus.defaultExpectation.paramPtrs.order = &order
	mmSetStatus.defaultExpectation.expectationOrigins.originOrder = minimock.CallerInfo(1)

	return mmSetStatus
}

// ExpectStatusParam3 sets up expected param status for OrderRepository.SetStatus
func (mmSetStatus *mOrderRepositoryMockSetStatus) ExpectStatusParam3(status model.Status) *mOrderRepositoryMockSetStatus {
	if mmSetStatus.mock.funcSetStatus != nil {
		mmSetStatus.mock.t.Fatalf("OrderRepositoryMock.SetStatus mock is already set by Set")
	}
...
func (mmSetStatus *mOrderRepositoryMockSetStatus) Inspect(f func(ctx context.Context, order model.Order, status model.Status)) *mOrderRepositoryMockSetStatus {
...
func (mmSetStatus *mOrderRepositoryMockSetStatus) Set(f func(ctx context.Context, order model.Order, status model.Status) (err error)) *OrderRepositoryMock {
	if mmSetStatus.defaultExpectation != nil {
...
// Then helper
func (mmSetStatus *mOrderRepositoryMockSetStatus) When(ctx context.Context, order model.Order, status model.Status) *OrderRepositoryMockSetStatusExpectation {
	if mmSetStatus.mock.funcSetStatus != nil {
		mmSetStatus.mock.t.Fatalf("OrderRepositoryMock.SetStatus mock is already set by Set")
	}
	...
	expectation := &OrderRepositoryMockSetStatusExpectation{
		...
		params:             &OrderRepositoryMockSetStatusParams{ctx, order, status},
...
func (mmSetStatus *OrderRepositoryMock) SetStatus(ctx context.Context, order model.Order, status model.Status) (err error) {
	...
	if mmSetStatus.inspectFuncSetStatus != nil {
		mmSetStatus.inspectFuncSetStatus(ctx, order, status)
	}

	mm_params := OrderRepositoryMockSetStatusParams{ctx, order, status}
	...
	if mmSetStatus.SetStatusMock.defaultExpectation != nil {
		...
		mm_got := OrderRepositoryMockSetStatusParams{ctx, order, status}
		...
		if mm_want_ptrs != nil {
			...
			if mm_want_ptrs.order != nil && !minimock.Equal(*mm_want_ptrs.order, mm_got.order) {
				mmSetStatus.t.Errorf("OrderRepositoryMock.SetStatus got unexpected parameter order, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmSetStatus.SetStatusMock.defaultExpectation.expectationOrigins.originOrder, *mm_want_ptrs.order, mm_got.order, minimock.Diff(*mm_want_ptrs.order, mm_got.order))
			}
	...
	if mmSetStatus.funcSetStatus != nil {
		return mmSetStatus.funcSetStatus(ctx, order, status)
	}
	mmSetStatus.t.Fatalf("Unexpected call to OrderRepositoryMock.SetStatus. %v %v %v", ctx, order, status)
	return
}
...
func (mmUpdateOrder *mOrderRepositoryMockUpdateOrder) Expect(ctx context.Context, order model.Order) *mOrderRepositoryMockUpdateOrder {
...
func (mmUpdateOrder *mOrderRepositoryMockUpdateOrder) ExpectOrderParam2(order model.Order) *mOrderRepositoryMockUpdateOrder {
	if mmUpdateOrder.mock.funcUpdateOrder != nil {
		mmUpdateOrder.mock.t.Fatalf("OrderRepositoryMock.UpdateOrder mock is already set by Set")
	}
...
func (mmUpdateOrder *mOrderRepositoryMockUpdateOrder) Inspect(f func(ctx context.Context, order model.Order)) *mOrderRepositoryMockUpdateOrder {
...
func (mmUpdateOrder *mOrderRepositoryMockUpdateOrder) Return(op1 *model.Order, err error) *OrderRepositoryMock {
	if mmUpdateOrder.mock.funcUpdateOrder != nil {
		mmUpdateOrder.mock.t.Fatalf("OrderRepositoryMock.UpdateOrder mock is already set by Set")
	}
	...
	mmUpdateOrder.defaultExpectation.results = &OrderRepositoryMockUpdateOrderResults{op1, err}
...
func (mmUpdateOrder *mOrderRepositoryMockUpdateOrder) Set(f func(ctx context.Context, order model.Order) (op1 *model.Order, err error)) *OrderRepositoryMock {
	if mmUpdateOrder.defaultExpectation != nil {
...
// Then helper
func (mmUpdateOrder *mOrderRepositoryMockUpdateOrder) When(ctx context.Context, order model.Order) *OrderRepositoryMockUpdateOrderExpectation {
	if mmUpdateOrder.mock.funcUpdateOrder != nil {
		mmUpdateOrder.mock.t.Fatalf("OrderRepositoryMock.UpdateOrder mock is already set by Set")
	}
...
func (e *OrderRepositoryMockUpdateOrderExpectation) Then(op1 *model.Order, err error) *OrderRepositoryMock {
	e.results = &OrderRepositoryMockUpdateOrderResults{op1, err}
	return e.mock
}
